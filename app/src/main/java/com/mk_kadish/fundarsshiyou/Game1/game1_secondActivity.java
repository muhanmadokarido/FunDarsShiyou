...
public class game1_secondActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        allpairs.add(new Game1KeyValue(R.drawable.correct_ar,R.drawable.correct));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (currentPos < 0) {
                        ...
                        MediaPlayer.create(game1_secondActivity.this, R.raw.parrot).start();
                        ...
                        if (currentPos == position) {
                            ...
                            if (!isMatch) {
                                ...
                                MediaPlayer mediaPlayer10 = MediaPlayer.create(game1_secondActivity.this, R.raw.dog);
                                mediaPlayer10.start();
                            }
                            else if (isMatch) {
                                ...
                                switch (currentPos) {
                                    case R.drawable.sample_0:
                                        MediaPlayer mediaPlayer2 = MediaPlayer.create(game1_secondActivity.this, R.raw.rabbit);
                                        mediaPlayer2.start();
                                        break;
                                    default:
                                        MediaPlayer mediaPlayer10 = MediaPlayer.create(game1_secondActivity.this, R.raw.lion);
                                        mediaPlayer10.start();
                                        break;
                                }
                                ...
                                if (countPair == maxnum) {
                                    MediaPlayer mediaPlayer3 = MediaPlayer.create(game1_secondActivity.this, R.raw.sound1);
                                    mediaPlayer3.start();
    ...
    private void startTimer() {
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(game1_secondActivity.this);
    ...
    public void passToNext(View view)
    {
        ...
        startActivity(new Intent(this,game1_thirdActivity.class));
        finish();
    }
