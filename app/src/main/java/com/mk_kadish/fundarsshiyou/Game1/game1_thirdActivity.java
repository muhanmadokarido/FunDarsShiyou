...
public class game1_thirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        myPoints= findViewById(R.id.l1_p3_tv6_Ponits);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (currentPos < 0) {
                    ...
                    MediaPlayer.create(game1_thirdActivity.this, R.raw.parrot).start();
                    ...
                    if (currentPos == position) {
                        ...
                        if (!isMatch) {
                            ...
                            MediaPlayer mediaPlayer10 = MediaPlayer.create(game1_thirdActivity.this, R.raw.dog);
                            mediaPlayer10.start();
                        }
                        else if (isMatch) {
                            isMatch = false;
                            ...
                            switch (currentPos) {
                                case R.drawable.sample_0:
                                    MediaPlayer mediaPlayer2 = MediaPlayer.create(game1_thirdActivity.this, R.raw.rabbit);
                                    mediaPlayer2.start();
                                    break;
                                default:
                                    MediaPlayer mediaPlayer10 = MediaPlayer.create(game1_thirdActivity.this, R.raw.lion);
                                    mediaPlayer10.start();
                                    break;
                            }
                            ...
                            if (countPair == maxnum) {
                                MediaPlayer mediaPlayer3 = MediaPlayer.create(game1_thirdActivity.this, R.raw.sound1);
                                mediaPlayer3.start();
                                try
                                {
                                    Thread.sleep(500);
    ...
    public void passToNext(View view)
    {
        ...
        startActivity(new Intent(this,game1_forthActivity.class));
        finish();
    }
